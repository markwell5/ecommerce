    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnalyticsOrders", x => x.OrderId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerRecords", x => x.UserId);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnalyticsOrders_CustomerId",
                table: "AnalyticsOrders",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_AnalyticsOrders_PlacedAt",
                table: "AnalyticsOrders",
                column: "PlacedAt");

            migrationBuilder.CreateIndex(
                name: "IX_AnalyticsOrders_Status",
                table: "AnalyticsOrders",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerRecords_RegisteredAt",
